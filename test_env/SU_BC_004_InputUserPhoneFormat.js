...
(async function inputUserName() {
    ...
    // 3.	Input Manual with wrong format phone number + alphabet
    const username = await page.$("#regis-input");
    await page.waitForTimeout(5000);
    await username.type("12345678A", { delay: 100 });
    ...
    // Screenshot
    await page.waitForTimeout(2000);
    await page.screenshot({ path: 'ss_test/SU_BC_004_InputUserPhoneFormat1.png' });
    ...
    // 6.	Input Manual with wrong format phone number + symbol
    await page.waitForTimeout(3000);
    ...
    // Screenshot
    await page.waitForTimeout(3000);
    await page.screenshot({ path: 'ss_test/SU_BC_004_InputUserPhoneFormat2.png' });
